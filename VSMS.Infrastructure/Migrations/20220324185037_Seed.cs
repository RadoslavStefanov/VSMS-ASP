...
namespace VSMS.Infrastructure.Migrations
{
    public partial class Seed : Migration
    {
        ...
        const string Employee_Role_Guid = "4dcfe457-f582-42bc-8919-64f57629315b";
        const string Guest_Role_Guid = "f7974a42-fd86-4d25-bcb6-37278edccce1";
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SaleId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql($"DELETE FROM AspNetRoles WHERE Id = '{Guest_Role_Guid}'");
            migrationBuilder.Sql($"DELETE FROM AspNetRoles WHERE Id = '{Restricted_Role_Guid}'");
        }
    }
}
